...
export default function Header() {
  ...
  return (
    <>
      ...
      >
        <div className="relative w-24 h-20 md:w-36 md:h-32">
          <img src="/okayama.svg" alt="okayama" className="w-full h-full drop-shadow-lg" />
          <div className="absolute top-[42%] left-[43%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
            <span className="text-sm md:text-lg font-bold leading-tight text-white drop-shadow-lg tracking-wide">tabilog</span>
            <span className="text-[9px] md:text-[11px] font-bold mt-0.5 text-white/95 drop-shadow-md">Day {day}</span>
          </div>
        </div>
      </Link>
