    ...
    <>
      ...
      >
        <div className="relative w-28 h-24 md:w-36 md:h-32">
          ...
          <div className="absolute top-[40%] md:top-[42%] left-[43%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center">
            <h1 className="text-[13px] md:text-lg font-bold text-white drop-shadow-lg tracking-wide">tabilog</h1>
            <p className="text-[10px] md:text-[11px] text-white/95 drop-shadow-md mt-0.5">Day {day}</p>
          </div>
        </div>
      </Link>
